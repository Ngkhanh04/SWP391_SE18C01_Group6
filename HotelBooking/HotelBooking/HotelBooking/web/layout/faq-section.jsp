...
<!--<section class="section faq-sec-two pt-0">
    <div class="faq-sec-bg">
        <img src="${pageContext.request.contextPath}/assets/img/bg/hotel-bg-05.svg" class="bg-1" alt="Img">
    </div>
    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="faq-five  wow zoomIn">
                        <img src="${pageContext.request.contextPath}/assets/img/faq/faq-02.png" alt="img">
                    </div>
                </div>
                <div class="col-lg-6">
