                    ...
                    <div class="header-btn d-flex align-items-center">
                        ...
                        <div class="dropdown profile-dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-3">
                                ...
                                <li>
                                    <a class="dropdown-item d-inline-flex align-items-center rounded fw-medium p-2" href="javascript:void(0);">Dashboard</a>
                                </li>
                                <% }%>
                                <li>
                                ...
                                <li>
                                    <a class="dropdown-item d-inline-flex align-items-center rounded fw-medium p-2" href="javascript:void(0);">My Booking</a>
                                </li>
                                <li>
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary me-0">Become Agent</a>
                        <% } else { %>
